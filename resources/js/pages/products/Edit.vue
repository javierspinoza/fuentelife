...
const submit = () => {
    form.transform((data) => ({
        ...data,
        _method: 'PUT',
    })).post(productRoutes.update(props.product.id).url, {
        preserveScroll: true,
        forceFormData: true,
        onSuccess: () => {
            // Reset solo el campo de imagen
            form.image = null;
        },
    });
};
    ...
    <AppLayout title="Editar Producto">
        <div class="container mx-auto py-8 px-4">
            ...
            <Card class="max-w-2xl">
                <CardHeader>
                    <CardTitle class="text-2xl">Editar Producto</CardTitle>
                    <CardDescription
                        >Actualiza la información del producto</CardDescription
                    >
                </CardHeader>
                <CardContent>
